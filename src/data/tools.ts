...
export const tools: Tool[] = [
  ...
  { id: 'purple-screen', name: 'Purple Screen', shortName: 'Purple', slug: 'purple-screen', localizedSlugs: localizedColor('pantalla-morada', 'tela-roxa', 'ecran-violet', 'lila-bildschirm', 'baingani-screen', 'murasaki-gamen'), category: 'colors', kind: 'color', color: '#7c3aed', rgb: '124, 58, 237', summary: 'A refined purple fullscreen field for ambient setups, color comparison, and creative backgrounds.', intent: 'a modern purple screen with precise controls', useCases: ['ambient desk setups', 'creative video backgrounds', 'palette comparison', 'screen uniformity checks'], controls: ['fullscreen', 'brightness', 'copy HEX', 'copy RGB', 'favorite colors'], faqs: colorFaqs('Purple Screen') },
  ...
  { id: 'rgb-screen', name: 'RGB Screen', shortName: 'RGB', slug: 'rgb-screen', localizedSlugs: {}, category: 'colors', kind: 'color', color: '#00ff88', rgb: '0, 255, 136', summary: 'A fullscreen RGB utility for entering, copying, cycling, and validating RGB color values.', intent: 'fast RGB workflows with full-screen preview', useCases: ['RGB value previews', 'developer color checks', 'animation testing', 'display channel experiments'], controls: ['fullscreen', 'brightness', 'RGB input', 'copy RGB', 'auto color cycle'], faqs: colorFaqs('RGB Screen') },
  { id: 'hex-screen', name: 'HEX Screen', shortName: 'HEX', slug: 'hex-screen', localizedSlugs: {}, category: 'colors', kind: 'color', color: '#171717', rgb: '23, 23, 23', summary: 'A fullscreen HEX color tool for designers, developers, and anyone who needs exact color previews.', intent: 'exact HEX entry with immediate fullscreen feedback', useCases: ['brand QA', 'CSS color previews', 'wallpaper testing', 'palette review'], controls: ['fullscreen', 'brightness', 'HEX input', 'copy HEX', 'HEX history'], faqs: colorFaqs('HEX Screen') },
  ...
  { id: 'fireplace-screen', name: 'Fireplace Screen', shortName: 'Fireplace', slug: 'fireplace-screen', localizedSlugs: {}, category: 'savers', kind: 'saver', color: 'linear-gradient(180deg, #190a05, #ff5a1f)', summary: 'A warm fireplace-inspired screen saver for ambience, background warmth, and cozy desk setups.', intent: 'ambient warm motion with restrained controls', useCases: ['desk ambience', 'TV background', 'seasonal displays', 'relaxed rooms'], controls: ['fullscreen', 'ambient mode', 'brightness', 'timer', 'reduced motion'], faqs: effectFaqs('Fireplace Screen') },
  { id: 'aquarium-screen', name: 'Aquarium Screen', shortName: 'Aquarium', slug: 'aquarium-screen', localizedSlugs: {}, category: 'savers', kind: 'saver', color: 'linear-gradient(180deg, #003d66, #00bcd4)', summary: 'A cool aquarium-style screen saver for calm backgrounds and always-on displays.', intent: 'cool aquatic ambience without heavy assets', useCases: ['calm desk background', 'waiting room display', 'blue ambient light', 'presentation breaks'], controls: ['fullscreen', 'ambient mode', 'brightness', 'timer', 'pause'], faqs: effectFaqs('Aquarium Screen') },
  { id: 'matrix-screen', name: 'Matrix Screen', shortName: 'Matrix', slug: 'matrix-screen', localizedSlugs: {}, category: 'savers', kind: 'saver', color: '#001b0b', summary: 'A dark green code-rain style screen saver for ambient terminal-inspired visuals.', intent: 'technical ambient motion with accessible controls', useCases: ['developer desk setup', 'event screens', 'video intros', 'low-light backgrounds'], controls: ['fullscreen', 'speed control', 'brightness', 'reduced motion', 'keyboard shortcuts'], faqs: effectFaqs('Matrix Screen') },
  { id: 'rain-screen', name: 'Rain Screen', shortName: 'Rain', slug: 'rain-screen', localizedSlugs: {}, category: 'savers', kind: 'saver', color: 'linear-gradient(180deg, #0f172a, #64748b)', summary: 'A soft rain-inspired screen saver for cool ambient backgrounds and focus sessions.', intent: 'subtle movement suited to long-running displays', useCases: ['focus sessions', 'background ambience', 'event holding screens', 'desk decor'], controls: ['fullscreen', 'ambient mode', 'brightness', 'timer', 'pause'], faqs: effectFaqs('Rain Screen') },
  { id: 'snow-screen', name: 'Snow Screen', shortName: 'Snow', slug: 'snow-screen', localizedSlugs: {}, category: 'savers', kind: 'saver', color: 'linear-gradient(180deg, #eff6ff, #ffffff)', summary: 'A light snow screen saver with calm motion for bright seasonal ambient displays.', intent: 'clean winter ambience that remains readable and gentle', useCases: ['seasonal displays', 'bright room ambience', 'event screens', 'background visuals'], controls: ['fullscreen', 'brightness', 'reduced motion', 'timer', 'ambient mode'], faqs: effectFaqs('Snow Screen') },
  { id: 'galaxy-screen', name: 'Galaxy Screen', shortName: 'Galaxy', slug: 'galaxy-screen', localizedSlugs: {}, category: 'savers', kind: 'saver', color: 'radial-gradient(circle, #7c3aed, #020617)', summary: 'A deep galaxy-inspired screen saver for dark ambient visuals and display backgrounds.', intent: 'space-inspired ambience with premium restraint', useCases: ['dark room background', 'TV ambience', 'streaming breaks', 'presentation staging'], controls: ['fullscreen', 'brightness', 'ambient mode', 'timer', 'share screen'], faqs: effectFaqs('Galaxy Screen') },
  ...
  { id: 'clock-screen', name: 'Clock Screen', shortName: 'Clock', slug: 'clock-screen', localizedSlugs: {}, category: 'savers', kind: 'saver', color: '#111111', summary: 'A clean fullscreen clock for spare displays, focus rooms, and always-on dashboards.', intent: 'readable time display with minimal visual noise', useCases: ['meeting rooms', 'desk clocks', 'kiosk displays', 'focus timers'], controls: ['fullscreen', 'brightness', 'timer', 'theme toggle', 'keyboard shortcuts'], faqs: effectFaqs('Clock Screen') },
  { id: 'ambient-screen', name: 'Ambient Screen', shortName: 'Ambient', slug: 'ambient-screen', localizedSlugs: {}, category: 'savers', kind: 'saver', color: 'linear-gradient(135deg, #007cf0, #ff0080, #f9cb28)', summary: 'A premium ambient screen with gentle color movement, timer controls, and fullscreen focus.', intent: 'beautiful low-effort ambience for any spare screen', useCases: ['desk setups', 'room lighting', 'video backgrounds', 'event displays'], controls: ['fullscreen', 'auto color cycle', 'timer', 'brightness', 'download wallpaper'], faqs: effectFaqs('Ambient Screen') },
  { id: 'broken-screen', name: 'Broken Screen', shortName: 'Broken', slug: 'broken-screen', localizedSlugs: {}, category: 'pranks', kind: 'prank', color: '#0b0b0b', summary: 'A harmless broken-screen prank page with a convincing fullscreen cracked-display effect.', intent: 'safe theatrical prank screen without downloads', useCases: ['friendly jokes', 'video scenes', 'stage props', 'demo effects'], controls: ['fullscreen', 'escape hint', 'brightness', 'share current screen', 'timer'], faqs: effectFaqs('Broken Screen') },
  ...
  { id: 'blue-screen-prank', name: 'Blue Screen Prank', shortName: 'Blue Screen', slug: 'blue-screen-prank', localizedSlugs: {}, category: 'pranks', kind: 'prank', color: '#0078d7', summary: 'A highly realistic Windows BSOD simulation with animated progress, stop codes, and fullscreen crash behavior.', intent: 'an authentic Windows BSOD experience that feels indistinguishable from the real screen', useCases: ['friendly pranks', 'video staging', 'training demos', 'presentation jokes'], controls: ['fullscreen', 'escape hint', 'animated progress', 'stop codes', 'QR code'], faqs: effectFaqs('Blue Screen Prank') },
